...
export class WeaponManager {
    constructor() {
        ...
        this.ammoEnabled = settings.get('gameplay.weapon.ammoEnabled') ?? false;
    ...
    switchWeapon(weaponId) {
        ...
        // 設定に保存
        settings.set('gameplay.weapon.selected', this.currentWeaponId);
     ...
     */
    getWeaponInfo() {
        const isLowAmmo = this.ammoEnabled && (this.currentAmmo / this.currentWeapon.magazineSize <= 0.25);
        return {
            name: this.currentWeapon.name, // i18n should be handled by caller if needed, or mapped here
    ...
    setAmmoEnabled(enabled) {
        ...
        settings.set('gameplay.weapon.ammoEnabled', enabled);
