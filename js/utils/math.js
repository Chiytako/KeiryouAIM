 ...
 */
export function calculateSensitivity(dpi, valorantSens) {
    // Valorantの360度回転距離を計算
    const cm360 = (360 * 2.54) / (dpi * valorantSens * 0.07);

    // ブラウザーでの感度に変換
    const browserSens = (360 / cm360) * (dpi / 1000);
